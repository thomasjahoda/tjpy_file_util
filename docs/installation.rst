...
To install Personal File Utility Library, run this command in your terminal:
...
The sources for Personal File Utility Library can be downloaded from the `Github repo`_.
